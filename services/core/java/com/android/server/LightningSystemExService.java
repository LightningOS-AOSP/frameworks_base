...
import com.android.internal.util.lightning.FullscreenTaskStackChangeListener;
...
public class LightningSystemExService extends SystemService {

    private static final String TAG = "LightningSystemExService";
    ...
    public LightningSystemExService(Context context) {
        super(context);
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            LightningSystemExService.this.onPackageRemoved(packageName);
        }
